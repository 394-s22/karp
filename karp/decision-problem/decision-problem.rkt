                   ...
                   [(_ arg-inst:id arg-cert:id body ...+)
                    ...
                    #`(begin
                        ...
                        (define/contract (solver-id-here a-instance)
                          ...
                          ;       in some cases the symbloic executioner can know
                          ...
                          ;(pretty-print (r:vc)) ;-- for debugging

                          #;(define solution ; for debugging
                              (r:solve
                             #t)) ; solve constraints already in assert store, nothing new to add

                          ;(pretty-print sym-cert) ;-- for debugging
                          ;(pretty-print (r:model solution)) ;-- for debugging
