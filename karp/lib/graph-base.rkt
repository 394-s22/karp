...
(require
  ...
  racket/random
  racket/stxparam
  [except-in "../decision-problem/dp-core.rkt" max min]
  "../decision-problem/dp-stx-info.rkt"
...
(define (out-neighbors g u)
  (neighbors g u))


(define (degree g u)
  (set-size (neighbors g u)))
(define (in-degree g u)
  (set-size (in-neighbors g u)))
(define (out-degree g u)
  (set-size (neighbors g u)))
