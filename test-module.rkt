#lang racket (module 3sat karp/problem-definition (require karp/lib/cnf karp/lib/mapping) (decision-problem #:name 3sat #:instance ( [φ is-a (cnf #:arity 3)]  ) #:certificate (mapping
 ...
 (∀ [c ∈ (clauses-of (φ a-inst))]
  ...
  ))(module iset karp/problem-definition (require karp/lib/graph) (decision-problem #:name iset #:instance ( [G is-a (graph #:undirected)] [k is-a natural]  ) #:certificate (subset-of (vertices-of G)))(define-iset-verifier a-inst a-cert 
 (define g (G a-inst)) 
 (and
